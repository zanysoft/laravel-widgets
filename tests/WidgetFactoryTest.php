...
use ZanySoft\Widgets\Test\Dummies\TestCachedWidget;
...
class WidgetFactoryTest extends TestCase
{
    ...
    {
        $this->expectException('\ZanySoft\Widgets\Misc\InvalidWidgetClassException');
    ...
    {
        $output = $this->factory->run('\ZanySoft\Widgets\Test\Dummies\TestDefaultSlider');
