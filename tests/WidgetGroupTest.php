...
class WidgetGroupTest extends TestCase
{
    ...
    public function testItCanDisplayWidgets()
    {
        ...
        $this->assertEquals(
            ...
            '<div id="zanysoft-widget-container-2" style="display:inline" class="zanysoft-widget-container">Placeholder here!'.
                '<script type="text/javascript">'.
                    'var widgetTimer2 = setInterval(function() {'.
                        'if (window.$) {'.
                            "$('#zanysoft-widget-container-2').load('".$this->ajaxUrl('Slider', [], 2)."');".
    ...
    public function testWrap()
    {
        ...
        $this->assertEquals(
            ...
            '<div class=\'widget widget-1-2\'><div id="zanysoft-widget-container-2" style="display:inline" class="zanysoft-widget-container">Placeholder here!'.
                '<script type="text/javascript">'.
                    'var widgetTimer2 = setInterval(function() {'.
                        'if (window.$) {'.
                            "$('#zanysoft-widget-container-2').load('".$this->ajaxUrl('Slider', [], 2)."');".
