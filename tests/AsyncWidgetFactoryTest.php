...
class AsyncWidgetFactoryTest extends TestCase
{
    ...
    public function testItCanRunAsyncWidget()
    {
        ...
        $expected =
            '<div id="zanysoft-widget-container-1" style="display:inline" class="zanysoft-widget-container">'.
                '<script type="text/javascript">'.
                    'var widgetTimer1 = setInterval(function() {'.
                        'if (window.$) {'.
                            "$('#zanysoft-widget-container-1').load('".$this->ajaxUrl('TestDefaultSlider')."');".
    ...
    public function testItCanRunAsyncWidgetWithPlaceholder()
    {
        ...
        $expected =
            '<div id="zanysoft-widget-container-1" style="display:inline" class="zanysoft-widget-container">Placeholder here!'.
                '<script type="text/javascript">'.
                    'var widgetTimer1 = setInterval(function() {'.
                        'if (window.$) {'.
                            "$('#zanysoft-widget-container-1').load('".$this->ajaxUrl('Slider')."');".
                            'clearInterval(widgetTimer1);'.
                        '}'.
                    '}, 100);'.
                '</script>'.
    ...
    public function testItCanRunMultipleAsyncWidgets()
    {
        ...
        $expected =
            '<div id="zanysoft-widget-container-2" style="display:inline" class="zanysoft-widget-container">'.
                '<script type="text/javascript">'.
                    'var widgetTimer2 = setInterval(function() {'.
                        'if (window.$) {'.
                            "$('#zanysoft-widget-container-2').load('".$this->ajaxUrl('TestDefaultSlider', [], 2)."');".
        ...
        $expected =
            '<div id="zanysoft-widget-container-1" style="display:inline" class="zanysoft-widget-container">Placeholder here!'.
                '<script type="text/javascript">'.
                    'var widgetTimer1 = setInterval(function() {'.
                        'if (window.$) {'.
                            "$('#zanysoft-widget-container-1').load('".$this->ajaxUrl('TestWidgetWithParamsInRun', $params)."');".
                            'clearInterval(widgetTimer1);'.
                        '}'.
                    '}, 100);'.
                '</script>'.
        ...
        $expected =
            '<div id="zanysoft-widget-container-1" style="display:inline" class="zanysoft-widget-container">'.
                '<script type="text/javascript">'.
                    'var widgetTimer1 = setInterval(function() {'.
                        'if (window.$) {'.
                            "$('#zanysoft-widget-container-1').load('".$this->ajaxUrl('Profile\TestNamespace\TestFeed')."');".
                            'clearInterval(widgetTimer1);'.
                        '}'.
                    '}, 100);'.
                '</script>'.
                    ...
                    'setTimeout(function() {'.
                        ...
                        'xhr.onreadystatechange = function() {'.
                            'if(xhr.readyState == 4 && xhr.status == 200) {'.
                                'var container = document.getElementById("zanysoft-widget-container-1");'.
